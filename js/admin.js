...
// Real-time WhatsApp / Phone Number Validation
if (inputNomorHp) {
    const waValidationMsg = document.createElement('div');
    waValidationMsg.id = 'waValidationMsg';
    waValidationMsg.style.fontSize = '0.85em';
    waValidationMsg.style.marginTop = '6px';
    waValidationMsg.style.fontWeight = '500';
    waValidationMsg.style.display = 'none';
    waValidationMsg.style.transition = 'all 0.2s';
    ...
    inputNomorHp.addEventListener('input', () => {
        ...
        waValidationMsg.style.display = 'block';
        if (isValid) {
            waValidationMsg.innerHTML = '<span style="color:#10b981;"><i class="fas fa-check-circle"></i> Format WhatsApp Valid (62...)</span>';
            inputNomorHp.style.borderColor = '#10b981';
            inputNomorHp.style.boxShadow = '0 0 0 3px rgba(16, 185, 129, 0.15)';
        } else {
            waValidationMsg.innerHTML = '<span style="color:#ef4444;"><i class="fas fa-times-circle"></i> Harus angka & diawali 62 (Contoh: 62812...)</span>';
            inputNomorHp.style.borderColor = '#ef4444';
            inputNomorHp.style.boxShadow = '0 0 0 3px rgba(239, 68, 68, 0.15)';
        }
    });
}
// -------------------------------------------------------------
...
if (addServiceForm) {
    addServiceForm.addEventListener('submit', async (e) => {
        ...
        const paymentStatus = document.getElementById('inputPaymentStatus').value;
